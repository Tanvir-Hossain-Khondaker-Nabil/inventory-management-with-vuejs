                    ...
                    <div class="card-body">
                        <form @submit.prevent="handleForm" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="category_name" v-model="form.category_name"
...
export default {
    ...
    created() {
        axios.get(`/api/category/${this.$route.params.id}`).then(({ data }) => (this.form = data)).catch();
    },
    methods: {
        fileUpload(e) {
        ...
        async handleForm() {
            ...
            data.append('category_name', this.form.category_name);
            data.append('_method', 'put');

            await axios.post(`/api/category/${this.$route.params.id}`, data)
